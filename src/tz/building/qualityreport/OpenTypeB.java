...
public class OpenTypeB extends Activity {
	FileContent fc;
	String fileName;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_open_type_b);
...
//		String end = b.getString("end");
		...
		if(fc==null){
		 ...
		 EditText editTextTitle = (EditText) findViewById(R.id.b_title);
		 editTextTitle.setText(fc.title);
		  
		 EditText editTextBody = (EditText) findViewById(R.id.b_body);
		 editTextBody.setText(fc.body);
		 
		 EditText editTextEnd = (EditText) findViewById(R.id.b_end);
...
//	} 
	...
	private void saveFile() {
		// TODO Auto-generated method stub
		EditText et=(EditText) findViewById(R.id.b_title);
		String ett=et.getText().toString();
		fc.title=ett;
		//fc.title=((EditText) findViewById(R.id.a_title)).getText().toString();
	    fc.body=((EditText) findViewById(R.id.b_body)).getText().toString();
	    fc.end=((EditText) findViewById(R.id.b_end)).getText().toString();
