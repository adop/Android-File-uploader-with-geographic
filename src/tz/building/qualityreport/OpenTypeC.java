...
public class OpenTypeC extends Activity {
	FileContent fc;
	String fileName;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_open_type_c);
...
//		String end = b.getString("end");
		...
		if(fc==null){
		 ...
		 EditText editTextTitle = (EditText) findViewById(R.id.c_title);
		 editTextTitle.setText(fc.title);
		  
		 EditText editTextBody = (EditText) findViewById(R.id.c_body);
		 editTextBody.setText(fc.body);
		 
		 EditText editTextEnd = (EditText) findViewById(R.id.c_end);
...
//	} 
	...
	private void saveFile() {
		// TODO Auto-generated method stub
		EditText et=(EditText) findViewById(R.id.c_title);
		String ett=et.getText().toString();
		fc.title=ett;
		//fc.title=((EditText) findViewById(R.id.a_title)).getText().toString();
	    fc.body=((EditText) findViewById(R.id.c_body)).getText().toString();
	    fc.end=((EditText) findViewById(R.id.c_end)).getText().toString();
